...
public class TestCaseV1 {
    ...
    public void updateData() {
        ...
        IntStream.range(0, DATA_SIZE).parallel().forEach(i -> {
            ...
            PersonProto.Person newPerson = PersonProto.Person.newBuilder(person).setName(person.getName() + "-xxx").build();
    ...
    private PersonProto.Person generatePerson(int i) {
        return PersonProto.Person.newBuilder().setId(i).setName("Gokhan").setEmail("aa@bb.com").build();
    }
}
